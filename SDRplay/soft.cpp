...
void update_reg_8(sdrplay_dev_t *p)
{
    mirisdr_write_reg(p, 0x08, p->reg8|(p->bias?(1<<(BIAS_GPIO+8)):0));
}

int mirisdr_set_soft(sdrplay_dev_t *p)
{
    ...
    switch (p->if_freq)
    {
    case if_freq_t::MIRISDR_IF_ZERO:
        reg0 |= MIRISDR_IF_MODE_ZERO << 12;
        break;
    case if_freq_t::MIRISDR_IF_450KHZ:
        reg0 |= MIRISDR_IF_MODE_450KHZ << 12;
        break;
    case if_freq_t::MIRISDR_IF_1620KHZ:
        reg0 |= MIRISDR_IF_MODE_1620KHZ << 12;
        break;
    case if_freq_t::MIRISDR_IF_2048KHZ:
    ...
    switch (p->bandwidth)
    {
    case bandwidth_t::MIRISDR_BW_200KHZ:
        reg0 |= 0x00 << 14;
        break;
    case bandwidth_t::MIRISDR_BW_300KHZ:
        reg0 |= 0x01 << 14;
        break;
    case bandwidth_t::MIRISDR_BW_600KHZ:
        reg0 |= 0x02 << 14;
        break;
    case bandwidth_t::MIRISDR_BW_1536KHZ:
        reg0 |= 0x03 << 14;
        break;
    case bandwidth_t::MIRISDR_BW_5MHZ:
        reg0 |= 0x04 << 14;
        break;
    case bandwidth_t::MIRISDR_BW_6MHZ:
        reg0 |= 0x05 << 14;
        break;
    case bandwidth_t::MIRISDR_BW_7MHZ:
        reg0 |= 0x06 << 14;
        break;
    case bandwidth_t::MIRISDR_BW_8MHZ:
        reg0 |= 0x07 << 14;
        break;
    }
    ...
    switch (p->xtal)
    {
    case xtal_t::MIRISDR_XTAL_19_2M:
        reg0 |= 0x00 << 17;
        break;
    case xtal_t::MIRISDR_XTAL_22M:
        reg0 |= 0x01 << 17;
        break;
    case xtal_t::MIRISDR_XTAL_24M:
    case xtal_t::MIRISDR_XTAL_24_576M:
        reg0 |= 0x02 << 17;
        break;
    case xtal_t::MIRISDR_XTAL_26M:
        reg0 |= 0x03 << 17;
        break;
    case xtal_t::MIRISDR_XTAL_38_4M:
        reg0 |= 0x04 << 17;
        break;
    }
...
int Sdrplay_set_center_freq(sdrplay_dev_t *p, uint32_t freq)
{
    p->freq = freq + p->freq_correction;
    int r = mirisdr_set_soft(p);
    r += Sdrplay_set_gain(p); // restore gain
    return r;
}

uint32_t Sdrplay_get_center_freq(sdrplay_dev_t *p)
{
    if (p == NULL)
        return -1;
    return p->freq;
...
int Sdrplay_set_if_freq(sdrplay_dev_t *p, uint32_t freq)
{
    if (!p)
        return -1;
    ...
    {
    case 0:
        p->if_freq = if_freq_t::MIRISDR_IF_ZERO;
        break;
    case 450000:
        p->if_freq = if_freq_t::MIRISDR_IF_450KHZ;
        break;
    case 1620000:
        p->if_freq = if_freq_t::MIRISDR_IF_1620KHZ;
        break;
    case 2048000:
        p->if_freq = if_freq_t::MIRISDR_IF_2048KHZ;
        break;
    default:
...
uint32_t Sdrplay_get_if_freq(sdrplay_dev_t *p)
{
    if (!p)
        return -1;
...
/* not supported yet */
int Sdrplay_set_xtal_freq(sdrplay_dev_t *p, uint32_t freq)
{
    (void) p;
    (void) freq;
    return -1;
...
uint32_t Sdrplay_get_xtal_freq(sdrplay_dev_t *p)
{
    if (!p)
        return -1;
...
int Sdrplay_set_bandwidth(sdrplay_dev_t *p, uint32_t bw)
{
    if (!p)
        return -1;
    ...
    {
    case 200000:
        p->bandwidth = bandwidth_t::MIRISDR_BW_200KHZ;
        break;
    case 300000:
        p->bandwidth = bandwidth_t::MIRISDR_BW_300KHZ;
        break;
    case 600000:
        p->bandwidth = bandwidth_t::MIRISDR_BW_600KHZ;
        break;
    case 1536000:
        p->bandwidth = bandwidth_t::MIRISDR_BW_1536KHZ;
        break;
    case 5000000:
        p->bandwidth = bandwidth_t::MIRISDR_BW_5MHZ;
        break;
    case 6000000:
        p->bandwidth = bandwidth_t::MIRISDR_BW_6MHZ;
        break;
    case 7000000:
        p->bandwidth = bandwidth_t::MIRISDR_BW_7MHZ;
        break;
    case 8000000:
        p->bandwidth = bandwidth_t::MIRISDR_BW_8MHZ;
        break;
    default:
...
uint32_t Sdrplay_get_bandwidth(sdrplay_dev_t *p)
{
    if (!p)
        return -1;
...
int Sdrplay_set_freq_correction(sdrplay_dev_t *p, int ppm)
{
    if (!p)
        return -1;

    p->freq_correction = ppm;
    return 0;
}

int Sdrplay_set_direct_sampling(sdrplay_dev_t *p, int on)
{
    (void) p;
    (void) on;
...
int Sdrplay_set_offset_tuning(sdrplay_dev_t *p, int on)
{
    if (!p)
        return -1;
...
int Sdrplay_set_transfer(sdrplay_dev_t *p, transfer_t tr)
{
    if (!p)
        return -1;
...
transfer_t Sdrplay_get_transfer(sdrplay_dev_t *p)
{
    return p->transfer;
}

mirisdr_band_t Sdrplay_get_band (sdrplay_dev_t *p)
{
    return p->band;
}

int Sdrplay_set_bias (sdrplay_dev_t *p, int bias)
{
	p->bias=bias;
	update_reg_8(p);
	return 0;
...
int Sdrplay_get_bias (sdrplay_dev_t *p)
{
	return p->bias;
}
